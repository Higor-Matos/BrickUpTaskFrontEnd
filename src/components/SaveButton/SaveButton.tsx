...
import "./SaveButton.css"; // Importe o CSS específico para o botão
  ...
  return (
    <button className="button">
      ...
      <div className="button-content">
          ...
          >
            ...
            <mask id="icon-payments-cat_svg__a" fill="#fff">
              <path
                fill-rule="evenodd"
                clip-rule="evenodd"
                d="M34.42 15.93c.382-1.145-.706-2.234-1.851-1.852l-18.568 6.189c-1.186.395-1.362 2-.29 2.644l5.12 3.072a1.464 1.464 0 001.733-.167l-5.154 4.638a1.464 1.464 0 011.958 2.177l-5.154 4.638a1.464 1.464 0 00-.276 1.841l3.101 5.17c.644 1.072 2.25.896 2.645-.29L34.42 15.93z"
              ></path>
            </mask>
            <path
              fill-rule="evenodd"
        ...
        <span className="button__text">Payments</span>
      </div>
    </button>
  );
};
